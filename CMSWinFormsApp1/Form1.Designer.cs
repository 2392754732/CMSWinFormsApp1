namespace CMSWinFormsApp1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            menuStrip1.Items.AddRange(new ToolStripItem[] { workerToolStripMenuItem, cToolStripMenuItem, jobDetailsToolStripMenuItem, reportsToolStripMenuItem, exitToolStripMenuItem });
            ...
            cToolStripMenuItem.ShortcutKeys = Keys.Alt | Keys.C;
            cToolStripMenuItem.Size = new Size(94, 24);
            cToolStripMenuItem.Text = "&Customer";
